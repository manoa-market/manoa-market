...
const ListingsElectronics = () => {
  ...
  const { ready, listings } = useTracker(() => {
    ...
    const electronicsFiltered = _.filter(unsoldItems, function (data) { return data.category === 'Electronics'; });
    return {
      listings: electronicsFiltered,
      ready: rdy,
    };
  }, []);
        ...
        <Row className="justify-content-center">
          <Col md={7}>
            <Col className="text-center">
              <h2 className="py-5">Electronics </h2>
            </Col>
...
export default ListingsElectronics;
