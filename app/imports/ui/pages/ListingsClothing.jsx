...
const ListingsClothing = () => {
  ...
  const { ready, listings } = useTracker(() => {
    ...
    const clothingFiltered = _.filter(unsoldItems, function (data) { return data.category === 'Clothing'; });
    return {
      listings: clothingFiltered,
      ready: rdy,
    };
  }, []);
...
export default ListingsClothing;
