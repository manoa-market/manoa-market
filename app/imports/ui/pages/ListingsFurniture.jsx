...
const ListingsFurniture = () => {
  ...
  const { ready, listings } = useTracker(() => {
    ...
    const furnitureFiltered = _.filter(unsoldItems, function (data) { return data.category === 'Furniture'; });
    return {
      listings: furnitureFiltered,
      ready: rdy,
    };
  }, []);
        ...
        <Row className="justify-content-center">
          <Col md={7}>
            <Col className="text-center">
              <h2 className="py-5">Furniture </h2>
            </Col>
...
export default ListingsFurniture;
